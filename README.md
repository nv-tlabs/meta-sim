...
Official PyTorch code (**coming soon**) for Meta-Sim (ICCV 2019). For technical details, please refer to:
...
<img src = "./docs/resources/meta-sim-gif.gif" width="100%" margin="auto"/>